...
import { HardHat, Calculator, Clock, Store, Hammer, Users, MessageCircle } from "lucide-react";
...
export default function ContractorHome() {
  return <RoleLanding role={{
    ...
    tools: [
      ...
      { icon: Clock, title: "Construction Estimator", desc: "Enter project tasks and get a job timeline with an automatic +20% time buffer.", to: "/construction-estimator", cta: "Estimate a Job" },
