// Boliviq 2026 pricing catalog — 7 membership tiers + AI token packs.
...
export const PLANS = [
  {
    ...
    restrictions: ["No AI access", "No AI tokens, assistants, reports or automation"],
  },
  {
  ...
  },
  {
    ...
    restrictions: ["No AI", "No AI tokens or assistance — everything manual"],
  },
  {
    id: "professional_ai", name: "Professional + AI", tagline: "Pro + AI (token-metered)",
    ...
    features: [
      ...
      "10,000 AI tokens included monthly — buy more anytime",
    ],
    restrictions: ["AI is not unlimited — every request consumes tokens"],
  },
  {
    id: "team_professional_ai", name: "Team Professional + AI", tagline: "Team + shared AI tokens, up to 5",
    ...
    features: [
      ...
      "Shared AI token wallet, assistants, reports & workflows",
      "Shared AI automations",
      "50,000 AI tokens included monthly — buy more anytime",
    ],
    restrictions: ["Unlimited AI is NOT included — shared tokens consumed per request"],
  },
  {
    id: "professional_ai_unlimited", name: "Professional AI Unlimited", tagline: "Unlimited AI, no tokens",
    ...
    features: [
      ...
      "Unlimited AI — no token usage or deductions",
  ...
  },
  {
    ...
    features: [
      ...
      "Unlimited shared AI — no tokens required",
...
export const TOKEN_PACKS = [
  { id: "tokens_5000", name: "5,000 AI Tokens", price: 49, tokens: 5000, priceId: "price_1TuivvGIUtciLaIvjbZLSNyr" },
  { id: "tokens_15000", name: "15,000 AI Tokens", price: 129, tokens: 15000, priceId: "price_1TuivvGIUtciLaIvxGRlnFg9", popular: true },
  { id: "tokens_50000", name: "50,000 AI Tokens", price: 399, tokens: 50000, priceId: "price_1TuivvGIUtciLaIvUXBwho8Y" },
];

export const AI_MODE = {
  none: { label: "No AI", badge: "bg-muted text-muted-foreground" },
  tokens: { label: "AI · Tokens", badge: "bg-primary/15 text-primary" },
